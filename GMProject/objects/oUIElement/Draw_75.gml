...
if (mouse_in_area_gui([x, y, x + width, y + height]) and device_mouse_check_button_released(0, mb_left) and data.owner != oUI.ui and oUI.editingdepth >= depth and name != undefined and !mouse_in_area_gui(editor_area) and !mouse_in_area_gui(editor_area2) and !instance_exists(oTagManager)) {
	oUI.load_info();
